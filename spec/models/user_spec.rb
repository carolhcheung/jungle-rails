...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    it "Error for User instance if the 'last name' is nil." do
    ...
    it "Error for User instance if the 'first name' is nil." do
    ...
    it "Error array [] for User instance if the 'password_confirmation' is nil" do
      @user = User.new(first_name: "test", last_name: "test", password: "testing1", password_confirmation: nil, email: "test@test.com")
      @user.save
